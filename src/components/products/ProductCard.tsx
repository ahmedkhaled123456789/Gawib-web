  ...
  return (
    <div className="relative  mb-4">
     <div className="bg-white border border-[#085E9C] rounded-xl shadow-md overflow-hidden pb-4 text-center transition hover:shadow-lg">
         ...
         {/* Top tab */}
      <div className="absolute -top-5 left-4  bg-[#F6F1EF] border border-[#085E9C] rounded-tr-3xl rounded-bl-3xl px-10 py-2 text-blue-900 font-bold text-sm shadow">
        {gamesCount} لعبة
      </div>
      ...
      <div className="mt-8 px-4">
        <img
          src={imgError ? "/images/categories/c1.png" : image}
          alt={title}
